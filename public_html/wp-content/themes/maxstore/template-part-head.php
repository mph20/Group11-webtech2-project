		...
		<header id="site-header" class="col-sm-4 hidden-xs rsrc-header text-center col-sm-push-4" role="banner"> 
			<?php if ( get_theme_mod( 'header-logo', '' ) != '' ) : ?>
				<div class="rsrc-header-img">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="https://i.imgur.com/O7Jp42I.png" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" /></a>
					
				</div>
			<?php else : ?>
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="amazon2logo" src="https://i.imgur.com/O7Jp42I.png">
